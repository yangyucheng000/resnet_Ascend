...
| outputs                    | probability                                                 |  
| Loss                       | 0.000356                                                    |
| Speed                      | 18.4ms/step（8pcs）                     |
| Total time                 | 6 mins                          |
| Parameters (M)             | 25.5                                                         |
| Checkpoint for Fine tuning | 179.7M (.ckpt file)                                         |
| config                    | [Link](https://gitee.com/mindspore/models/tree/master/official/cv/resnet/config) | 
...
| outputs                    | probability                                                 | 
| Loss                       | 1.6453942                                                    | 
| Speed                      | 30.3ms/step（8pcs）                     |
| Total time                 | 301 mins                          | 
| Parameters (M)             | 44.6                                                        |
| Checkpoint for Fine tuning | 343M (.ckpt file)                                         |
| config                    | [Link](https://gitee.com/mindspore/models/tree/master/official/cv/resnet/config) | 
